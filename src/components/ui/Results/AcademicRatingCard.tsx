interface AcademicRatingCardProps {
  title?: string;
  scoreLabel?: string;
  progress?: number;
...
export default function AcademicRatingCard({
  title = "Academic Rating",
  scoreLabel = "Оценка – 6 / 6",
  progress = 99,
  description,
}: AcademicRatingCardProps) {
  return (
    <div
    ...
    >
      ...
      <div className="relative space-y-4 text-white">
        ...
        >
          <div
            className="h-full bg-blue-400 transition-all duration-1000 ease-out rounded-full relative"
            style={{
              width: `${progress}%`,
              boxShadow:
